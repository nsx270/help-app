...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    helpAppAuthUserSubject.add(
      HelpAppAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<HelpAppAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  HelpAppAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = HelpAppAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    helpAppAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
